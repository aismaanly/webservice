...
def init_db():
    try:
        ...
        con.close()
    return ({"status":"ok, db dan tabel berhasil dibuat"})
...
class Mhs(BaseModel):
    ...
    id_prov:str
    angkatan: str
    tinggi_badan: Optional[int] | None = None
...
# menggunakan "kosong" dan -9999 supaya bisa membedakan apakah tdk diupdate ("kosong") atau mau diupdate dengan dengan None atau 0
